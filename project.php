  ...
  <header>
    ...
    <div class="d-flex justify-content-end">
      <div class="card mb-3" style="max-width: 540px;">
        <div class="row g-0">
          <div class="col-md-4">
            <img src="E3BE538B-F13A-4A3B-8067-6CFAB816503C.jpeg" class="img-fluid rounded-start" alt="...">
          </div>
          <div class="col-md-8">
            <div class="card-body">
              <h5 class="card-title">จัดทำโดย</h5>
              <p class="card-text">นายสาวอุรัสยาพาขวัญ ปลั่งศรีทรัพย์</p>
              <p class="card-text"><small class="text-muted">ม.6/13 เลขที่ 27 , 55819</small></p>
            </div>
          </div>
        </div>
      </div>
